...
public class AcroConverterTest {
    ...
    public void convertJson() throws IOException {
        ...
        String schema = "{\"namespace\":\"com.jnj.adf.adf-kafka\",\"name\":\"com.jnj.adf.adf-kafka\",\"type\":\"record\",\"fields\":[{\"name\":\"f1\",\"type\":\"boolean\"},{\"name\":\"_UPT_\",\"type\":\"long\"},{\"name\":\"_UPUN_\",\"type\":\"boolean\"},{\"name\":\"_INST_\",\"type\":\"long\"},{\"name\":\"_INSUN_\",\"type\":\"boolean\"},{\"name\":\"_DELETED_\",\"type\":\"boolean\"},{\"name\":\"__SYSTEM_NAME__\",\"type\":\"boolean\"},{\"name\":\"__operation__\",\"type\":\"boolean\"}]}";
        String schemaTest = converter.convert(json).replaceAll("\r\n", "").replaceAll(" ", "");
